...
public class Torrent {
    ...
    public Torrent(String name, String hash, long added_on, long completion_on, long last_activity, long size, int dl_limit, int up_limit, int num_incomplete, double ratio) {
        this.name = name;
        this.hash = hash;
